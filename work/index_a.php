	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Colegio <small>Datos</small></h1>
			</div>
		</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
            ...
            <div class="col-sm-12">
	                        ...
	                        <label>Nombre </label>
	                        <input type="text" name="nombre" class="form-control" id="nombre" placeholder="Ingrese nombre de colegio" maxlength="">
	                        <br>
	                    </div>
	                    <div class="col-md-6">
...
$(document).ready(function(){
	...
	$(document).on('click', '.edit', function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				$('#hidden_id').val(data.id_bimestre);
				$('#bimestre').val(data.nombre);
                $('#bimestre').val(data.direccion);
                $('#bimestre').val(data.email);
