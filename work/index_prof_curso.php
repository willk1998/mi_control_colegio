	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Datos de Curso <small>Tiles</small></h1>
			</div>
		</div>
...
<div id="apicrudModal" class="modal fade bs-example-modal-lg" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="panel-body">
	                    <div class="col-sm-12">
	                        ...
	                        <label>Curso </label>
	                        <input type="text" name="id_curso" class="form-control" id="id_curso" placeholder="Ingrese Nombres" maxlength="">
	                        <br>
	                    </div>
	                    <div class="col-md-6">
	                        <label>Materia </label>
	                         <input type="text" name="id_materia" class="form-control" id="id_materia" placeholder="Ingrese Apellido Paterno" maxlength="">
	                       <br>
	                    </div>
	                    <div class="col-md-6">
	                        <label >Profesor </label>
	                        <input type="text" name="id_profesor" class="form-control" id="id_profesor" placeholder="Ingrese Apellido Materno" maxlength="">
	                        <br>
	                    </div>       
	                    <div class="col-md-6">
	                        <label>Paralelo </label>
	                        <input type="text" name="id_paralelo" class="form-control" id="id_paralelo" placeholder="Ingrese Numero Movil" maxlength="">
	                            <br>
	                    </div>
						<div class="col-md-6">
	                        <label>Estudiante </label>
	                        <input type="text" name="id_estudiante" class="form-control" id="id_estudiante" placeholder="Ingrese Numero Movil" maxlength="">
	                            <br>
	                    </div>  
		...
		<input type="hidden" name="hidden_id" id="hidden_id" />
			    	...
			    	<input type="submit" name="button_action" id="button_action" class="btn btn-info  btn-raised" value="Insert" />
...
$(document).ready(function(){
	...
	$('#add_button').click(function(){
		...
		$('.modal-title').text('DATOS PROF CURSO');
	...
	$('#api_crud_form').on('submit', function(event){
		...
		{
			alert("Ingrese id_materia ");
		}
		else if($('#id_profesor').val() == '')
		{
			alert("Ingresar id_profesor");
		}
		else if($('#id_paralelo').val() == '')
		{
			alert("Ingresar id_paralelo");
		}
		else if($('#id_estudiante').val() == '')
		{
			alert("Ingresar id_estudiante");
		}
		else
		{
			var form_data = $(this).serialize();
			$.ajax({
				url:"action_prof_curso.php",
				method:"POST",
				data:form_data,
				success:function(data)
				{
