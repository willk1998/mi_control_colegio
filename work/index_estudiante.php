	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Estudiante <small>Datos</small></h1>
			</div>
		</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="panel-body">
						...
						<div class="col-md-6">
	                        <label>Cargo </label>
	                        <input type="text" name="cargo" class="form-control" id="cargo" placeholder="Ingrese Cargo" maxlength="">
	                            <br>
	                    </div>  
	                    <div class="col-md-8">
                        ...
                        <div class="col-md-6">
	                        <label>Padre </label>
	                        <input type="text" name="id_padre" class="form-control" id="id_padre" placeholder="Ingrese Nombre Padre" maxlength="">
	                            <br>
	                    </div>
						<div class="col-md-6">
	                        <label>Profesor </label>
	                        <input type="text" name="id_profesor" class="form-control" id="id_profesor" placeholder="Ingrese Numero Profesor" maxlength="">
	                            <br>
	                    </div>   
	                    <div class="col-sm-4">
...
$(document).ready(function(){
	...
	$('#api_crud_form').on('submit', function(event){
        ...
        else if($('#id_padre').val() == '')
		{
			alert("Ingresar id padre");
		}
	...
	$(document).on('click', '.edit', function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				$('#hidden_id').val(data.id_estudiante);
