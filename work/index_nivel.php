	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Nivel <small>Datos</small></h1>
			</div>
		</div>
		...
		<div class="modal-content">
			<form method="post" id="api_crud_form">
				<div class="modal-header">
		        	...
		        	<h4 class="modal-title">Datos Nivel</h4>
		      	</div>
		      	<div class="modal-body">
			<div class="panel-body">
	                    <div class="col-sm-12">
	                        ...
	                        <label>Nivel </label>
	                        <input type="text" name="nombre" class="form-control" id="nombre" placeholder="Ingrese Nivel" maxlength="">
	                        <br>
	                    </div>
...
$(document).ready(function(){
	...
	$('#add_button').click(function(){
		...
		$('.modal-title').text('Datos de Nivel');
