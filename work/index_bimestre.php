	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Bimestre <small>Datos</small></h1>
			</div>
		</div>
		...
		<div class="modal-content">
			<form method="post" id="api_crud_form">
				<div class="modal-header">
		        	...
		        	<h4 class="modal-title">Datos Bimestre</h4>
		      	</div>
		      	<div class="modal-body">
			<div class="panel-body">
	                    <div class="col-sm-12">
	                        ...
	                        <input type="text" name="bimestre" class="form-control" id="bimestre" placeholder="Ingrese bimestres" maxlength="">
	                        <br>
	                    </div>
...
$(document).ready(function(){
	...
	$('#add_button').click(function(){
		...
		$('.modal-title').text('Datos de Bimestre');
