	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Asistencia <small>Datos</small></h1>
			</div>
		</div>
		...
		<div class="modal-content">
			...
			<div class="panel-body">
	                    <div class="col-sm-12">
	                        ...
	                        <label>Estado </label>
	                        <input type="text" name="estado" class="form-control" id="estado" placeholder="Ingrese estados" maxlength="">
	                        <br>
	                    </div>
	                    <div class="col-md-6">
	                        <label>Fecha </label>
	                         <input type="text" name="fecha" class="form-control" id="fecha" placeholder="Ingrese fecha" maxlength="">
	                       <br>
	                    </div>
	                    <div class="col-md-6">
...
$(document).ready(function(){
	...
	$('#add_button').click(function(){
		...
		$('.modal-title').text('Datos de Asistencia');
