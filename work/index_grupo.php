	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Grupo <small>Datos</small></h1>
			</div>
		</div>
            ...
            <div class="col-sm-12">
	                    ...
	                    <div class="col-md-6">
	                        <label>Id Paralelo </label>
	                         <input type="text" name="id_paralelo" class="form-control" id="id_paralelo" placeholder="Ingrese Id Paralelo" maxlength="">
	                       <br>
	                    </div>
	                    <div class="col-md-6">
	                        <label >Id Materia </label>
	                        <input type="text" name="id_materia" class="form-control" id="id_materia" placeholder="Ingrese Id Materia" maxlength="">
	                        <br>
	                    </div>       
...
$(document).ready(function(){
	...
	$('#add_button').click(function(){
		...
		$('.modal-title').text('Datos de Grupo');
	...
	$('#api_crud_form').on('submit', function(event){
		...
		{
			alert("Ingrese id_paralelo ");
		}
		else if($('#id_materia').val() == '')
		{
			alert("Ingresar id_materia");
		}
