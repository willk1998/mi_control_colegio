...
CREATE TABLE `colegio` (
  `id_colegio` int(18) NOT NULL AUTO_INCREMENT,
...
insert  into `colegio`(`id_colegio`,`nombre`,`direccion`,`email`) values 
(1,'san antonio','cbba','admin@admin'),
(2,'san antonio anotnio v','cbba','admin@admin');
...
CREATE TABLE `cuenta` (
  `id_persona` int(18) DEFAULT NULL,
  `id_rol` int(18) DEFAULT NULL,
  KEY `id_rol` (`id_rol`),
  KEY `id_persona` (`id_persona`),
  CONSTRAINT `cuenta_ibfk_1` FOREIGN KEY (`id_rol`) REFERENCES `rol` (`id_rol`),
  CONSTRAINT `cuenta_ibfk_2` FOREIGN KEY (`id_persona`) REFERENCES `usuario` (`id_persona`)
...
CREATE TABLE `curso` (
  ...
  `id_nivel` int(18) DEFAULT NULL,
  `id_colegio` int(18) DEFAULT NULL,
  PRIMARY KEY (`id_curso`),
  KEY `id_nivel` (`id_nivel`),
  KEY `id_colegio` (`id_colegio`),
  CONSTRAINT `curso_ibfk_1` FOREIGN KEY (`id_nivel`) REFERENCES `nivel` (`id_nivel`),
  CONSTRAINT `curso_ibfk_2` FOREIGN KEY (`id_colegio`) REFERENCES `colegio` (`id_colegio`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `estudiante` (
  `id_persona` int(18) NOT NULL,
  `rude` int(50) DEFAULT NULL,
...
insert  into `estudiante`(`id_persona`,`rude`) values 
(1,888),
(2,4545454);
...
CREATE TABLE `gestion` (
  `id_gestion` int(18) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(18) DEFAULT NULL,
  PRIMARY KEY (`id_gestion`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `gestion` */
...
CREATE TABLE `grupo` (
  `id_grupo` int(18) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(18) DEFAULT NULL,
  ...
  CONSTRAINT `grupo_ibfk_1` FOREIGN KEY (`id_paralelo`) REFERENCES `paralelo` (`id_paralelo`),
...
CREATE TABLE `inscrito` (
  `id_persona` int(18) NOT NULL,
  `id_curso` int(18) NOT NULL,
  `id_gestion` int(18) NOT NULL,
  `fecha` date DEFAULT NULL,
  PRIMARY KEY (`id_persona`,`id_curso`,`id_gestion`),
  KEY `id_curso` (`id_curso`),
  KEY `id_gestion` (`id_gestion`),
  CONSTRAINT `inscrito_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `estudiante` (`id_persona`),
  CONSTRAINT `inscrito_ibfk_2` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id_curso`),
  CONSTRAINT `inscrito_ibfk_3` FOREIGN KEY (`id_gestion`) REFERENCES `gestion` (`id_gestion`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `inscrito` */
...
CREATE TABLE `nivel` (
  `id_nivel` int(18) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) DEFAULT NULL,
...
CREATE TABLE `nota` (
  ...
  `id_curso` int(18) NOT NULL,
  `id_gestion` int(18) NOT NULL,
  `id_grupo` int(18) NOT NULL,
  `nota_b1` int(18) DEFAULT NULL,
  `nota_b2` int(18) DEFAULT NULL,
  `nota_b3` int(18) DEFAULT NULL,
  `nota_b4` int(18) DEFAULT NULL,
  `nota_final` int(18) DEFAULT NULL,
  PRIMARY KEY (`id_persona`,`id_curso`,`id_gestion`,`id_grupo`),
  KEY `id_curso` (`id_curso`),
  KEY `id_gestion` (`id_gestion`),
  KEY `id_grupo` (`id_grupo`),
  CONSTRAINT `nota_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `inscrito` (`id_persona`),
  CONSTRAINT `nota_ibfk_2` FOREIGN KEY (`id_curso`) REFERENCES `inscrito` (`id_curso`),
  CONSTRAINT `nota_ibfk_3` FOREIGN KEY (`id_gestion`) REFERENCES `inscrito` (`id_gestion`),
  CONSTRAINT `nota_ibfk_4` FOREIGN KEY (`id_grupo`) REFERENCES `grupo` (`id_grupo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `padre_familia` (
  ...
  `fecha` date DEFAULT NULL,
  PRIMARY KEY (`id_persona`),
  CONSTRAINT `padre_familia_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id_persona`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `paralelo` (
  ...
  `codigo` char(18) DEFAULT NULL,
  `id_gestion` int(18) DEFAULT NULL,
  `id_curso` int(18) DEFAULT NULL,
  PRIMARY KEY (`id_paralelo`),
  KEY `id_gestion` (`id_gestion`),
  KEY `id_curso` (`id_curso`),
  CONSTRAINT `paralelo_ibfk_1` FOREIGN KEY (`id_gestion`) REFERENCES `gestion` (`id_gestion`),
  CONSTRAINT `paralelo_ibfk_2` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id_curso`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `persona` (
  `id_persona` int(18) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) DEFAULT NULL,
...
insert  into `persona`(`id_persona`,`nombre`,`papellido`,`sapellido`,`direccion`,`telefono`,`celular`,`dni`,`email`) values 
(1,'william','villca','sandoval','cbba',727810,7777777,8837,'villca@gmail.com'),
(2,'juana','morale','asdasd','c',1,1,1,'d@.com'),
(3,'33','3','3','3',3,3,3,'3'),
(4,'6','666','6','6',66,66,6,'6');
...
insert  into `profesor`(`id_persona`,`fecha`) values 
(1,'2019-10-25');
